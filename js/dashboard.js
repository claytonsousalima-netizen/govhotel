...
async function _carregarDashboard(hotelId) {
  ...
  document.getElementById('stats-grid').innerHTML = `
    <div style="margin-bottom:6px;">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:12px;">
        ...
        <div class="stat-card s-blue">
          <div class="stat-label">Em Arrumação</div>
    ...
    govEl.innerHTML = `
      <div class="card" style="padding:16px 18px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(130px,1fr));gap:10px;">
          ...
          ${_govCard('Em Arrumação',   limpando,   '#2e86c1', 'em andamento')}
  ...
  const labels   = {livre:'Vago',sujo:'Sujo',limpando:'Arrumação',conferencia:'Inspeção',bloqueado:'Bloqueado',ocupado:'Ocupado',manutencao:'Manutenção'};
